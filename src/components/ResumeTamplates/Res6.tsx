...
export const Res6: React.FC = () => {
	...
	return (
		<div
			...
			style={{ maxWidth: "700px", minWidth: "700px", minHeight: "800px" }}
		>
					...
					<div className="mb-6">
						...
						<ul className="grid gap-3 text-[11px] font-medium">
							{pathName === "download-resume" ? (
								resumePhone ? (
									<li className="flex gap-3 items-center">
										<img className="w-3" src={phone} alt="phone icon" />
							...
							{pathName === "download-resume" ? (
								resumeEmail ? (
									<li className="flex gap-3 items-center">
										<img className="w-3" src={letter} alt="envelope icon" />
									...
									return (
										<div className="mb-5" key={idx}>
											...
											<p className="mb-2 text-[11px] font-medium capitalize">
												{el?.companyName}
												{el?.companyName ? <span>|</span> : null}{" "}
												{el?.startDate}{" "}
												{el?.endDate ? <span> - </span> : null}{" "}
												{el?.endDate}
											</p>
									...
									return (
										<div className="mb-5" key={idx}>
											...
											<p className="mb-2 text-[11px] font-medium capitalize">
												{item?.instructionName}
												{item?.educationStartDate}{" "}
												{item?.educationEndDate ? <span> - </span> : null}{" "}
												{item?.educationEndDate}
											</p>
											<ul className="text-[11px] font-medium">
												{item?.educationAbout ? (
